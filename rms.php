...
<head>
    ...
    <title>GSO - Management Information System</title>
...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color:rgba(32, 129, 237, 4)">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="chmsc.png" style="height:30px;width:40px;align:center" alt="...">General Services Office - Management Information System</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color:rgba(32, 129, 237, 4)">
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color:rgba(32, 129, 237, 4)">
            <?php 
            include 'db.php';
...
$page = $_GET['page'];
$pages = array('home', 'Lists', 'subjects','order_p','records','record','addrecord','report','program','statistical','form137','list_report','student_report','users','school_year','school_year2','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs', 'request/index');
if (!empty($page)) {
