...
$pdf->Table($conn,"SELECT material_requisition.QUANTITY,equip_pro.ARTICLE,material_requisition.NAME,material_requisition.DETAILS From material_requisition join equip_pro on equip_pro.ID=material_requisition.EQUIP_ID ");
$pdf->AddPage();
