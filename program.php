    ...
    <div class="panel-body">     
      <table id="students" class="table table-hover table-bordered">
        ...
        <tbody>
          <?php
          include 'db.php';
          $sql=  mysqli_query($conn, "SELECT * FROM program WHERE TYPE = 'Equipment' ORDER BY EQUIP_TYPE");
      ...
      <div class="main-login main-center">
        ...
        <form class="" method="post" >
          ...
          <div class="form-group">
            <label for="sub" class="cols-sm-2 control-label">Type of Equipment/Supply</label>
            <div class="cols-sm-4">
...
<div class="col-md-8">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title"><h3 class="page-header">Type of Supply / <small>section</small></h3></h3>
    </div> 
    <div class="panel-body">     
      <table id="students1" class="table table-hover table-bordered">
        <thead>
          <tr id="heads">
            <th style="width:10%">Type of Supply</th>
            <th>Type</th>
            <th style="width:30%">Description</th>
            <th style="width:20%">Action</th>
          </tr>
        ...
        <tbody>
          <?php
          include 'db.php';
          $sql=  mysqli_query($conn, "SELECT * FROM program WHERE TYPE = 'Supply' ORDER BY EQUIP_TYPE");
          while($row = mysqli_fetch_assoc($sql)) {
          ?>
          <form class="" method="post" >
            <tr>
